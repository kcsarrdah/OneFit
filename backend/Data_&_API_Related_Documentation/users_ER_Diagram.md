...
erDiagram
    users {
        ...
        string timezone "OPTIONAL - User timezone, defaults to UTC"
        ...
        int target_calories "OPTIONAL - Daily calorie goal"
        int target_water "OPTIONAL - Daily water goal in mL, defaults to 2000"
        json goals "OPTIONAL - Simple fitness goals and preferences"
        json settings "OPTIONAL - App settings and preferences"
    ...
    weight_logs {
        ...
        string notes "OPTIONAL - User notes about the measurement"
        timestamp created_at "REQUIRED"
    }
